$(document).ready(function () {
    ...
    // MATERIALBOX (GALLERY ZOOM) - Re-init with safety
    if (typeof $.fn.materialbox === 'function') {
        $('.materialboxed:not(.materialized-initialized)').addClass('materialized-initialized').materialbox();
    }
});