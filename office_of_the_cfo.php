...
if (!function_exists('cfoOut')) {
    function cfoOut($sections, $section_key, $field_key, $default = '') {
...
if (!function_exists('cfoIcon')) {
    function cfoIcon($sections, $section_key, $field_key, $default = 'star') {
...
<style>
    ...
    .cfo-card { transition: transform .35s ease, box-shadow .35s ease, border-color .35s ease; }
    .cfo-card:hover { transform: translateY(-6px); box-shadow: 0 26px 50px -22px rgba(15, 23, 42, .40); }

    /* Sticky portrait rail on large screens only */
    @media (min-width: 1024px) {
        .cfo-sticky { position: sticky; top: 110px; }
    }

    /* Prose flows as one continuous column at every width. */
    .cfo-bio p + p { margin-top: 1.5rem; }
</style>
...
<main class="flex-grow bg-gray-50 dark:bg-gray-900">
            ...
            <div class="cfo-wrap">
                <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center lg:items-start">
                    ...
                    <div class="w-full max-w-sm lg:max-w-none lg:w-1/4 animate-fadeInUp">
                        <div class="cfo-sticky relative group">
                            ...
                            <div class="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-gray-800">
                                <img src="<?php echo strip_tags(getContent($pageContent, 'officer_profile', 'profile_image', 'images/leadership/dr-francis-osei-kuffour.jpg')); ?>"
                                     alt="<?php echo cfoOut($pageContent, 'officer_profile', 'name', 'Chief Finance Officer'); ?>"
                                     class="w-full h-full object-cover object-top">
                            </div>
                            <div class="mt-6 text-center lg:text-left">
                                <h2 class="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white mb-1 tracking-tight"><?php echo cfoOut($pageContent, 'officer_profile', 'name', 'Chief Finance Officer'); ?></h2>
                                <p class="text-base font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest"><?php echo cfoOut($pageContent, 'officer_profile', 'title', 'Chief Finance Officer'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-3/4 space-y-10 animate-fadeInUp" style="animation-delay: 0.2s;">
                        <div>
                            <span class="inline-block px-5 py-2 mb-6 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-base font-black uppercase tracking-widest">
                                <?php echo cfoOut($pageContent, 'officer_profile', 'section_label', 'Meet the Chief Finance Officer'); ?>
                            </span>
                            <h3 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-5 tracking-tight"><?php echo cfoOut($pageContent, 'officer_profile', 'section_title', 'Profile & Biography'); ?></h3>
                            <div class="h-2 w-32 bg-yellow-400 rounded-full mb-8"></div>
                            <div class="cfo-bio text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                                <?php for ($i = 1; $i <= 5; $i++):
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 text-base font-black uppercase tracking-widest">
                    <?php echo cfoOut($pageContent, 'career_timeline', 'section_label', 'A Career in Finance'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo cfoOut($pageContent, 'career_timeline', 'section_title', 'Professional Journey'); ?>
                </h2>
                ...
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo cfoOut($pageContent, 'career_timeline', 'section_description', ''); ?>
                </p>
            </div>

            <div class="relative cfo-wrap">
                <!-- vertical rail -->
                ...
                <div class="relative pl-14 sm:pl-20 lg:pl-0 mb-10 lg:mb-14 lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                    ...
                    <div class="<?php echo $left ? 'lg:col-start-1 lg:row-start-1' : 'lg:col-start-2 lg:row-start-1'; ?>">
                        <article class="cfo-card group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-lg border <?php echo $current ? 'border-yellow-300 dark:border-yellow-600/60 ring-2 ring-yellow-400/40' : 'border-gray-100 dark:border-gray-800'; ?>">
                            ...
                            <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                <?php echo cfoOut($pageContent, 'career_timeline', "step_{$n}_text", ''); ?>
                            </p>
                        </article>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-base font-black uppercase tracking-widest">
                    <?php echo cfoOut($pageContent, 'credentials', 'section_label', 'Qualifications'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo cfoOut($pageContent, 'credentials', 'section_title', 'Academic & Professional Standing'); ?>
                </h2>
                <div class="h-2 w-36 bg-green-600 mx-auto rounded-full mb-7"></div>
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo cfoOut($pageContent, 'credentials', 'section_description', ''); ?>
                </p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 cfo-wrap">
                <!-- Academic -->
                <div class="p-10 sm:p-12 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-lg">
                    <h3 class="flex items-center gap-4 text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-8">
                        ...
                        <?php echo cfoOut($pageContent, 'credentials', 'academic_title', 'Academic Qualifications'); ?>
                    </h3>
                    <ul class="space-y-6">
                        <?php for ($n = 1; $n <= 4; $n++):
                        ...
                        <li class="flex gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-lg text-gray-600 dark:text-gray-400"><?php echo cfoOut($pageContent, 'credentials', "academic_{$n}_text", ''); ?></p>
                            </div>
                        </li>
                        <?php endfor; ?>
                    </ul>
                ...
                <div class="p-10 sm:p-12 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-lg">
                    <h3 class="flex items-center gap-4 text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-8">
                        ...
                        <?php echo cfoOut($pageContent, 'credentials', 'memberships_title', 'Professional Bodies'); ?>
                    </h3>
                    <ul class="space-y-5">
                        <?php for ($n = 1; $n <= 5; $n++):
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-base font-black uppercase tracking-widest">
                    <?php echo cfoOut($pageContent, 'professional_service', 'section_label', 'Beyond the Office'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo cfoOut($pageContent, 'professional_service', 'section_title', 'Teaching, Mentorship & Service'); ?>
                </h2>
                <div class="h-2 w-36 bg-purple-600 mx-auto rounded-full"></div>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 cfo-wrap">
                <?php for ($n = 1; $n <= 6; $n++):
                    $stitle = getContent($pageContent, 'professional_service', "service_{$n}_title");
                    if ($stitle === '') continue; ?>
                <div class="cfo-card group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800">
                    <div class="w-16 h-16 rounded-2xl bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-5 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-4xl"><?php echo cfoIcon($pageContent, 'professional_service', "service_{$n}_icon"); ?></span>
                    </div>
                    <h4 class="text-2xl font-black text-gray-900 dark:text-white mb-3 leading-tight"><?php echo htmlspecialchars($stitle, ENT_QUOTES, 'UTF-8'); ?></h4>
                    <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                        <?php echo cfoOut($pageContent, 'professional_service', "service_{$n}_text", ''); ?>
                    </p>
                </div>
                <?php endfor; ?>
            </div>
    ...
    <section class="py-24 sm:py-32 bg-white dark:bg-gray-900">
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-base font-black uppercase tracking-widest">
                    <?php echo cfoOut($pageContent, 'office_mandate', 'section_label', 'The Office'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo cfoOut($pageContent, 'office_mandate', 'section_title', 'Mandate of the Office'); ?>
                </h2>
                <div class="h-2 w-36 bg-yellow-400 mx-auto rounded-full mb-7"></div>
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo cfoOut($pageContent, 'office_mandate', 'section_description', ''); ?>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 cfo-wrap">
                <?php for ($n = 1; $n <= 6; $n++):
                    ...
                    if ($ititle === '') continue; ?>
                <div class="cfo-card group p-10 bg-gray-50 dark:bg-gray-800/50 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800">
                    <div class="w-16 h-16 rounded-2xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-5 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-4xl"><?php echo cfoIcon($pageContent, 'office_mandate', "item_{$n}_icon"); ?></span>
                    </div>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                        <?php echo cfoOut($pageContent, 'office_mandate', "item_{$n}_text", ''); ?>
                    </p>
                </div>
                <?php endfor; ?>
            </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-base font-black uppercase tracking-widest">
                    <?php echo cfoOut($pageContent, 'related_offices', 'section_label', 'Explore Further'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo cfoOut($pageContent, 'related_offices', 'section_title', 'Related Offices & Resources'); ?>
                </h2>
                <div class="h-2 w-32 bg-blue-600 mx-auto rounded-full"></div>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 cfo-wrap">
                <?php for ($n = 1; $n <= 4; $n++):
                    $ltitle = getContent($pageContent, 'related_offices', "link_{$n}_title");
                    if ($ltitle === '') continue; ?>
                <a href="<?php echo cfoOut($pageContent, 'related_offices', "link_{$n}_url", '#'); ?>"
                   class="cfo-card group block p-9 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 no-underline shadow-lg">
                    <div class="w-14 h-14 rounded-xl bg-gray-50 dark:bg-gray-800 text-blue-600 dark:text-blue-400 flex items-center justify-center shadow mb-5 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-3xl"><?php echo cfoIcon($pageContent, 'related_offices', "link_{$n}_icon", 'link'); ?></span>
                    </div>
                    ...
                    <p class="text-base text-gray-600 dark:text-gray-400 leading-relaxed mb-4"><?php echo cfoOut($pageContent, 'related_offices', "link_{$n}_text", ''); ?></p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div>
                            <span class="inline-block px-4 py-1.5 mb-5 rounded-full bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-sm font-black uppercase tracking-widest">
                                <?php echo cfoOut($pageContent, 'office_contact', 'section_label', 'Get in Touch'); ?>
                            </span>
                            <h3 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tight"><?php echo cfoOut($pageContent, 'office_contact', 'section_title', 'Contact the Office'); ?></h3>
                            <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-9 leading-relaxed">
                                <?php echo cfoOut($pageContent, 'office_contact', 'section_description', ''); ?>
                            </p>
                        ...
                        <div class="bg-white dark:bg-gray-800/50 p-10 sm:p-12 rounded-[2rem] border border-gray-100 dark:border-gray-700">
                            <h4 class="text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight"><?php echo cfoOut($pageContent, 'office_contact', 'form_title', 'Financial Inquiry'); ?></h4>
                            <p class="text-lg text-gray-600 dark:text-gray-400 mb-7 leading-relaxed">
                                <?php echo cfoOut($pageContent, 'office_contact', 'form_description', ''); ?>
                            </p>
                            <form action="contact_process.php" method="post" class="space-y-4">
                                <input type="hidden" name="inquiry-type" value="Financial Inquiry - Office of the Chief Finance Officer">
                                <div>
                                    <label for="cfo_name" class="sr-only">Full name</label>
                                    <input id="cfo_name" name="name" type="text" required placeholder="Your Full Name"
                                ...
                                <div>
                                    <label for="cfo_email" class="sr-only">Email address</label>
                                    <input id="cfo_email" name="email" type="email" required placeholder="Email Address"
                                           class="w-full px-6 py-5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-600 focus:border-blue-600 outline-none text-lg transition">
                                </div>
                                <div>
                                    <label for="cfo_msg" class="sr-only">Your inquiry</label>
                                    <textarea id="cfo_msg" name="message" rows="5" required placeholder="Your Inquiry"
                                ...
                                <button type="submit" class="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white text-xl font-black rounded-2xl transition-all shadow-lg hover:shadow-blue-500/25 flex items-center justify-center gap-2">
                                    ...
                                    <?php echo cfoOut($pageContent, 'office_contact', 'form_btn_text', 'Submit Inquiry'); ?>
                                </button>
                            </form>
                        </div>
                    </div>
    ...
    <section class="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div class="container relative z-10">
            <div class="cfo-wrap text-center">
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight tracking-tight">
                    <?php echo cfoOut($pageContent, 'cta_section', 'cta_title', 'Financial Transparency &'); ?>
                    <span class="text-yellow-400 block mt-2"><?php echo cfoOut($pageContent, 'cta_section', 'cta_highlight', 'Accountability'); ?></span>
                </h2>
                <p class="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-10 max-w-4xl mx-auto leading-relaxed">
                    <?php echo cfoOut($pageContent, 'cta_section', 'cta_description', ''); ?>
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo cfoOut($pageContent, 'cta_section', 'button_1_url', 'fees-structure.php'); ?>" class="px-10 py-5 bg-yellow-400 hover:bg-yellow-300 text-blue-900 text-lg font-black rounded-2xl transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        <span class="material-symbols-outlined text-3xl">description</span>
                        <?php echo cfoOut($pageContent, 'cta_section', 'button_1_text', 'Financial Reports'); ?>
                    </a>
                    <a href="<?php echo cfoOut($pageContent, 'cta_section', 'button_2_url', 'contact_us.php'); ?>" class="px-10 py-5 bg-white/10 hover:bg-white/20 text-white text-lg font-black rounded-2xl transition-all backdrop-blur-md border-2 border-white/30 transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        <span class="material-symbols-outlined text-3xl">mail</span>
                        <?php echo cfoOut($pageContent, 'cta_section', 'button_2_text', 'Contact Finance'); ?>
                    </a>
                </div>
            </div>
        </div>
