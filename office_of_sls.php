...
$page_title = $page ? $page['page_title'] . " - Valley View University" : "Office of the Dean of Spiritual Life and Development - Valley View University";
$active_page = "about";
            ...
            <div class="max-w-8xl mx-auto">
                <div class="flex flex-col lg:flex-row gap-16 items-center lg:items-start">
                    ...
                    <div class="w-full lg:w-1/3 animate-fadeInUp">
                        <div class="relative group">
                            ...
                            <div class="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-gray-800">
                                <img src="<?php echo strip_tags(getContent($pageContent, 'sls_profile', 'profile_image', 'https://via.placeholder.com/400x500/8b5cf6/ffffff?text=SLS')); ?>" 
                                     alt="<?php echo strip_tags(getContent($pageContent, 'sls_profile', 'name', 'Dean of Spiritual Life and Development')); ?>" class="w-full h-full object-cover">
                            </div>
                            <div class="mt-8 text-center lg:text-left">
                                <h2 class="text-5xl font-black text-gray-900 dark:text-white mb-2"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'name', 'Dean of Spiritual Life and Development')); ?></h2>
                                <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'title', 'Dean, Spiritual Life and Development')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-2/3 space-y-10 animate-fadeInUp" style="animation-delay: 0.2s;">
                        <div>
                            <h3 class="text-5xl font-black text-gray-900 dark:text-white mb-6"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'section_title', 'Spiritual Leadership')); ?></h3>
                            ...
                            <div class="space-y-6 text-4xl sm:text-5xl font-bold text-gray-700 dark:text-gray-300 leading-relaxed">
                                <p>
                                    <?php echo strip_tags(getContent($pageContent, 'sls_profile', 'bio_paragraph_1', 'The Office of the Dean of Spiritual Life and Development nurtures the spiritual growth and character development of the Valley View University community, grounded in Seventh-day Adventist values and Christian principles.')); ?>
                                </p>
                                <p>
                                    <?php echo strip_tags(getContent($pageContent, 'sls_profile', 'bio_paragraph_2', 'Through worship services, spiritual programs, counseling, and community outreach, we create opportunities for students and staff to deepen their faith, develop moral character, and live out their Christian calling in service to others.')); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-3xl border-l-8 border-blue-600">
                                ...
                                <h4 class="text-4xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'experience_title', 'Spiritual Formation')); ?></h4>
                                <p class="text-3xl text-gray-600 dark:text-gray-400 font-bold"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'experience_text', 'Guiding students in their spiritual journey and faith development.')); ?></p>
                            </div>
                            <div class="p-8 bg-yellow-50 dark:bg-yellow-900/20 rounded-3xl border-l-8 border-yellow-500">
                                ...
                                <h4 class="text-4xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'impact_title', 'Community Service')); ?></h4>
                                <p class="text-3xl text-gray-600 dark:text-gray-400 font-bold"><?php echo strip_tags(getContent($pageContent, 'sls_profile', 'impact_text', 'Inspiring service and outreach to the broader community.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-24 bg-gray-50 dark:bg-gray-950">
        <div class="container">
            <div class="max-w-8xl mx-auto text-center mb-20">
                <h2 class="text-5xl sm:text-6xl md:text-7xl font-black text-gray-900 dark:text-white mb-6"><?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'section_title', 'Spiritual Programs & Ministries')); ?></h2>
                ...
                <p class="text-4xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                    <?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'section_description', 'Comprehensive spiritual development programs that nurture faith, character, and service.')); ?>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:-translate-y-2">
                    ...
                    <h4 class="text-5xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_1_title', 'Worship Services')); ?></h4>
                    <p class="text-3xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                        <?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_1_description', 'Regular chapel services, vespers, and worship gatherings that inspire spiritual growth and community fellowship.')); ?>
                    </p>
                </div>
                ...
                <div class="group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:-translate-y-2">
                    ...
                    <h4 class="text-5xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_2_title', 'Bible Study')); ?></h4>
                    <p class="text-3xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                        <?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_2_description', 'Small group Bible studies and discipleship programs that deepen understanding of Scripture and Christian living.')); ?>
                    </p>
                </div>
                ...
                <div class="group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:-translate-y-2">
                    ...
                    <h4 class="text-5xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_3_title', 'Outreach Ministry')); ?></h4>
                    <p class="text-3xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                        <?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_3_description', 'Community service projects and evangelistic initiatives that put faith into action through service to others.')); ?>
                    </p>
                </div>
                ...
                <div class="group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:-translate-y-2">
                    ...
                    <h4 class="text-5xl font-black text-gray-900 dark:text-white mb-4"><?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_4_title', 'Spiritual Counseling')); ?></h4>
                    <p class="text-3xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                        <?php echo strip_tags(getContent($pageContent, 'spiritual_programs', 'pillar_4_description', 'Confidential spiritual guidance and pastoral care to support students through life challenges and spiritual questions.')); ?>
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        <div>
                            ...
                            <p class="text-4xl text-gray-600 dark:text-gray-400 mb-10 font-medium">
                                <?php echo strip_tags(getContent($pageContent, 'contact_section', 'section_description', 'For spiritual guidance, pastoral care, or ministry involvement opportunities, please reach out to our chaplaincy team.')); ?>
                            </p>
                            <div class="space-y-8">
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:<?php echo strip_tags(getContent($pageContent, 'contact_section', 'email', 'chaplain@vvu.edu.gh')); ?>" class="text-3xl font-bold text-gray-900 dark:text-white hover:text-blue-600 transition-colors"><?php echo strip_tags(getContent($pageContent, 'contact_section', 'email', 'chaplain@vvu.edu.gh')); ?></a>
                                    </div>
                                </div>
                                <div class="flex items-center gap-6">
                                ...
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo strip_tags(getContent($pageContent, 'contact_section', 'office_location', 'Chaplaincy Office, Campus Chapel')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container relative z-10">
            <div class="max-w-7xl mx-auto text-center">
                <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
                    <?php echo strip_tags(getContent($pageContent, 'cta_section', 'cta_title', 'Faith, Character &')); ?> <br><span class="text-yellow-400 text-5xl sm:text-6xl md:text-7xl lg:text-5xl block mt-2"><?php echo strip_tags(getContent($pageContent, 'cta_section', 'cta_highlight', 'Service')); ?></span>
                </h2>
                <p class="text-lg sm:text-xl md:text-2xl text-blue-100 mb-12 max-w-6xl mx-auto leading-relaxed font-medium">
                    <?php echo strip_tags(getContent($pageContent, 'cta_section', 'cta_description', 'Growing together in faith and service as we prepare to make a positive impact in the world.')); ?>
                </p>
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="<?php echo strip_tags(getContent($pageContent, 'cta_section', 'button_1_url', '#')); ?>" class="px-10 py-5 bg-yellow-400 hover:bg-yellow-300 text-blue-900 text-xl font-bold rounded-2xl transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        ...
                        <?php echo strip_tags(getContent($pageContent, 'cta_section', 'button_1_text', 'Ministry Programs')); ?>
                    </a>
                    <a href="<?php echo strip_tags(getContent($pageContent, 'cta_section', 'button_2_url', 'contact_us.php')); ?>" class="px-10 py-5 bg-white/10 hover:bg-white/20 text-white text-xl font-bold rounded-2xl transition-all backdrop-blur-md border-2 border-white/30 transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        ...
                        <?php echo strip_tags(getContent($pageContent, 'cta_section', 'button_2_text', 'Get Involved')); ?>
                    </a>
                </div>
            </div>
        </div>
