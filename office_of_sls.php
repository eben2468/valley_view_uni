...
$page = $content->getPageBySlug('office_of_sls');
...
if (!function_exists('slsOut')) {
    function slsOut($sections, $section_key, $field_key, $default = '') {
...
if (!function_exists('slsIcon')) {
    function slsIcon($sections, $section_key, $field_key, $default = 'star') {
        $icon = preg_replace('/[^a-z0-9_]/', '', strtolower(getContent($sections, $section_key, $field_key, $default)));
        return $icon !== '' ? $icon : $default;
    }
}

$page_title = $page ? $page['page_title'] . " - Valley View University" : "Office of Spiritual Life & Development - Valley View University";
$active_page = "about";
...
<style>
    ...
    .sls-card { transition: transform .35s ease, box-shadow .35s ease, border-color .35s ease; }
    .sls-card:hover { transform: translateY(-6px); box-shadow: 0 26px 50px -22px rgba(15, 23, 42, .40); }

    /* Decorative opening quote for the welcome message */
    .sls-quote-mark {
    ...
    @media (min-width: 1024px) {
        .sls-sticky { position: sticky; top: 110px; }
    }

    /* Prose flows as one continuous column at every width. */
    .sls-bio p + p,
    .sls-message p + p { margin-top: 1.5rem; }
</style>
...
<main class="flex-grow bg-gray-50 dark:bg-gray-900">
        ...
        <div class="container relative z-10 py-24">
            <div class="max-w-5xl mx-auto text-center">
                <div class="inline-flex items-center gap-3 px-10 py-4 mb-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 animate-fadeInUp shadow-2xl">
                    ...
                    <span class="text-xl md:text-2xl font-black tracking-widest uppercase text-yellow-400"><?php echo strip_tags(getContent($pageContent, 'hero_section', 'badge_text', 'Spiritual Growth')); ?></span>
                </div>
                ...
                <h1 class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-none tracking-tighter text-white mb-10 animate-fadeInUp drop-shadow-2xl" style="animation-delay: 0.1s;">
                    ...
                    <span class="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-200 to-yellow-500 block mt-4"><?php echo strip_tags(getContent($pageContent, 'hero_section', 'title_highlight', 'Spiritual Life & Development')); ?></span>
                </h1>

                <p class="text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed max-w-4xl mx-auto animate-fadeInUp font-bold drop-shadow-lg italic" style="animation-delay: 0.2s;">
                    "<?php echo strip_tags(getContent($pageContent, 'hero_section', 'subtitle', 'Nurturing the spiritual growth and character development of the Valley View University community through faith-based initiatives and service.')); ?>"
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="sls-wrap">
                <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center lg:items-start">
                    ...
                    <div class="w-full max-w-sm lg:max-w-none lg:w-1/4 animate-fadeInUp">
                        <div class="sls-sticky relative group">
                            ...
                            <div class="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-gray-800">
                                <img src="<?php echo strip_tags(getContent($pageContent, 'officer_profile', 'profile_image', 'images/leadership/pr-peter-obeng-manu.jpg')); ?>"
                                     alt="<?php echo slsOut($pageContent, 'officer_profile', 'name', 'Dean of Spiritual Life and Development'); ?>"
                                     class="w-full h-full object-cover object-top">
                            </div>
                            <div class="mt-6 text-center lg:text-left">
                                <h2 class="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white mb-1 tracking-tight"><?php echo slsOut($pageContent, 'officer_profile', 'name', 'Dean of Spiritual Life and Development'); ?></h2>
                                <p class="text-base font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest"><?php echo slsOut($pageContent, 'officer_profile', 'title', 'Dean of Spiritual Life and Development'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-3/4 space-y-10 animate-fadeInUp" style="animation-delay: 0.2s;">
                        <div>
                            <span class="inline-block px-5 py-2 mb-6 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-base font-black uppercase tracking-widest">
                                <?php echo slsOut($pageContent, 'officer_profile', 'section_label', 'Meet the Dean'); ?>
                            </span>
                            <h3 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-5 tracking-tight"><?php echo slsOut($pageContent, 'officer_profile', 'section_title', 'Profile & Biography'); ?></h3>
                            <div class="h-2 w-32 bg-yellow-400 rounded-full mb-8"></div>
                            <div class="sls-bio text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                                <?php for ($i = 1; $i <= 4; $i++):
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="p-9 bg-blue-50 dark:bg-blue-900/20 rounded-3xl border-l-8 border-blue-600">
                                <span class="material-symbols-outlined text-5xl text-blue-600 mb-3">church</span>
                                <h4 class="text-2xl font-black text-gray-900 dark:text-white mb-2"><?php echo slsOut($pageContent, 'officer_profile', 'highlight_1_title', 'Ordained Minister'); ?></h4>
                                <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo slsOut($pageContent, 'officer_profile', 'highlight_1_text', ''); ?></p>
                            </div>
                            <div class="p-9 bg-yellow-50 dark:bg-yellow-900/20 rounded-3xl border-l-8 border-yellow-500">
                                <span class="material-symbols-outlined text-5xl text-yellow-500 mb-3">interests</span>
                                <h4 class="text-2xl font-black text-gray-900 dark:text-white mb-2"><?php echo slsOut($pageContent, 'officer_profile', 'highlight_2_title', 'Personal Interests'); ?></h4>
                                <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo slsOut($pageContent, 'officer_profile', 'highlight_2_text', ''); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container relative z-10">
            <div class="sls-wrap">
                <div class="text-center mb-14">
                    <span class="inline-block px-5 py-2 mb-6 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-base font-black uppercase tracking-widest">
                        <?php echo slsOut($pageContent, 'welcome_message', 'section_label', 'From the Office'); ?>
                    </span>
                    <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                        <?php echo slsOut($pageContent, 'welcome_message', 'section_title', 'A Word of Welcome'); ?>
                    </h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                        ...
                        <div class="sls-sticky">
                            <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                                <div class="relative aspect-[4/5] bg-gray-100 dark:bg-gray-800 overflow-hidden">
                                    <img src="<?php echo strip_tags(getContent($pageContent, 'welcome_message', 'signature_image', 'images/leadership/pr-peter-obeng-manu.jpg')); ?>"
                                         alt="<?php echo slsOut($pageContent, 'welcome_message', 'signature_name', 'Dean of Spiritual Life and Development'); ?>"
                                         loading="lazy"
                                         class="w-full h-full object-cover object-top">
                                    <div class="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-black/70 to-transparent"></div>
                                    <div class="absolute bottom-4 left-5 right-5">
                                        <p class="text-white text-xl font-black leading-tight drop-shadow"><?php echo slsOut($pageContent, 'welcome_message', 'signature_name', ''); ?></p>
                                        <p class="text-yellow-300 text-sm font-bold uppercase tracking-widest"><?php echo slsOut($pageContent, 'welcome_message', 'signature_title', ''); ?></p>
                                    </div>
                                </div>

                                <?php $pull = getContent($pageContent, 'welcome_message', 'pull_quote'); ?>
                                <?php if ($pull !== ''): ?>
                    ...
                    <div class="lg:col-span-9">
                        <div class="relative bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 p-10 sm:p-16">
                            <span class="sls-quote-mark absolute -top-2 left-8 text-[10rem] sm:text-[13rem] text-blue-600/10 dark:text-blue-400/10 pointer-events-none">&ldquo;</span>

                            <div class="relative">
                                <?php $greeting = getContent($pageContent, 'welcome_message', 'greeting'); ?>
                                <?php if ($greeting !== ''): ?>
                                <h3 class="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white mb-6 tracking-tight leading-tight">
                                    <?php echo htmlspecialchars($greeting, ENT_QUOTES, 'UTF-8'); ?>
                                </h3>
                                <?php endif; ?>

                                <div class="sls-message text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                                    <?php for ($i = 1; $i <= 5; $i++):
                                        $para = getContent($pageContent, 'welcome_message', "paragraph_{$i}");
                                        if ($para === '') continue;
                                        $lead = ($i === 1); ?>
                                ...
                                <div class="mt-10 pt-8 border-t border-gray-100 dark:border-gray-800 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-xl sm:text-2xl font-black text-gray-900 dark:text-white leading-tight"><?php echo slsOut($pageContent, 'welcome_message', 'signature_name', ''); ?></p>
                                        <p class="text-base font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest"><?php echo slsOut($pageContent, 'welcome_message', 'signature_title', ''); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-base font-black uppercase tracking-widest">
                    <?php echo slsOut($pageContent, 'ministries', 'section_label', 'Our Ministries'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo slsOut($pageContent, 'ministries', 'section_title', 'Programmes & Ministries'); ?>
                </h2>
                ...
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo slsOut($pageContent, 'ministries', 'section_description', ''); ?>
                </p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sls-wrap">
                <?php for ($n = 1; $n <= 6; $n++):
                    $ititle = getContent($pageContent, 'ministries', "item_{$n}_title");
                    if ($ititle === '') continue; ?>
                <div class="sls-card group p-10 bg-gray-50 dark:bg-gray-800/50 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800">
                    <div class="w-16 h-16 rounded-2xl bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-5 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-4xl"><?php echo slsIcon($pageContent, 'ministries', "item_{$n}_icon"); ?></span>
                    </div>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                        <?php echo slsOut($pageContent, 'ministries', "item_{$n}_text", ''); ?>
                    </p>
                </div>
                <?php endfor; ?>
            </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 text-base font-black uppercase tracking-widest">
                    <?php echo slsOut($pageContent, 'leadership_roles', 'section_label', 'Track Record'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo slsOut($pageContent, 'leadership_roles', 'section_title', 'Ministry & Service'); ?>
                </h2>
                <div class="h-2 w-36 bg-blue-600 mx-auto rounded-full mb-7"></div>
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo slsOut($pageContent, 'leadership_roles', 'section_description', ''); ?>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sls-wrap">
                <?php for ($n = 1; $n <= 6; $n++):
                    ...
                    if ($rtitle === '') continue; ?>
                <div class="sls-card group p-10 bg-white dark:bg-gray-900 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800">
                    <div class="flex items-center justify-between mb-6">
                        <div class="w-16 h-16 rounded-2xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            <span class="material-symbols-outlined text-4xl"><?php echo slsIcon($pageContent, 'leadership_roles', "role_{$n}_icon"); ?></span>
                        </div>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                        <?php echo slsOut($pageContent, 'leadership_roles', "role_{$n}_text", ''); ?>
                    </p>
                </div>
                <?php endfor; ?>
            </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-base font-black uppercase tracking-widest">
                    <?php echo slsOut($pageContent, 'credentials', 'section_label', 'Qualifications'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo slsOut($pageContent, 'credentials', 'section_title', 'Academic & Professional Standing'); ?>
                </h2>
                <div class="h-2 w-36 bg-green-600 mx-auto rounded-full mb-7"></div>
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                    <?php echo slsOut($pageContent, 'credentials', 'section_description', ''); ?>
                </p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sls-wrap">
                <!-- Academic -->
                <div class="p-10 sm:p-12 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-lg">
                    <h3 class="flex items-center gap-4 text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-8">
                        ...
                        <?php echo slsOut($pageContent, 'credentials', 'academic_title', 'Academic Background'); ?>
                    </h3>
                    <ul class="space-y-6">
                        <?php for ($n = 1; $n <= 4; $n++):
                        ...
                        <li class="flex gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-lg text-gray-600 dark:text-gray-400"><?php echo slsOut($pageContent, 'credentials', "academic_{$n}_text", ''); ?></p>
                            </div>
                        </li>
                        <?php endfor; ?>
                    </ul>
                ...
                <div class="p-10 sm:p-12 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-lg">
                    <h3 class="flex items-center gap-4 text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-8">
                        ...
                        <?php echo slsOut($pageContent, 'credentials', 'competencies_title', 'Key Competencies'); ?>
                    </h3>
                    <ul class="space-y-5">
                        <?php for ($n = 1; $n <= 5; $n++):
                            $c = getContent($pageContent, 'credentials', "competency_{$n}");
                            if ($c === '') continue; ?>
                        <li class="flex items-start gap-4">
                            <span class="material-symbols-outlined text-3xl text-green-600 shrink-0">check_circle</span>
                            <span class="text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-200 leading-snug"><?php echo htmlspecialchars($c, ENT_QUOTES, 'UTF-8'); ?></span>
                        </li>
                        <?php endfor; ?>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="max-w-5xl mx-auto text-center mb-16">
                <span class="inline-block px-5 py-2 mb-6 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-base font-black uppercase tracking-widest">
                    <?php echo slsOut($pageContent, 'related_offices', 'section_label', 'Explore Further'); ?>
                </span>
                <h2 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-5 tracking-tight">
                    <?php echo slsOut($pageContent, 'related_offices', 'section_title', 'Related Offices & Resources'); ?>
                </h2>
                <div class="h-2 w-32 bg-blue-600 mx-auto rounded-full"></div>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sls-wrap">
                <?php for ($n = 1; $n <= 4; $n++):
                    $ltitle = getContent($pageContent, 'related_offices', "link_{$n}_title");
                    if ($ltitle === '') continue; ?>
                <a href="<?php echo slsOut($pageContent, 'related_offices', "link_{$n}_url", '#'); ?>"
                   class="sls-card group block p-9 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 no-underline shadow-lg">
                    <div class="w-14 h-14 rounded-xl bg-gray-50 dark:bg-gray-800 text-blue-600 dark:text-blue-400 flex items-center justify-center shadow mb-5 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-3xl"><?php echo slsIcon($pageContent, 'related_offices', "link_{$n}_icon", 'link'); ?></span>
                    </div>
                    ...
                    <p class="text-base text-gray-600 dark:text-gray-400 leading-relaxed mb-4"><?php echo slsOut($pageContent, 'related_offices', "link_{$n}_text", ''); ?></p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div>
                            <span class="inline-block px-4 py-1.5 mb-5 rounded-full bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-sm font-black uppercase tracking-widest">
                                <?php echo slsOut($pageContent, 'office_contact', 'section_label', 'Get in Touch'); ?>
                            </span>
                            <h3 class="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tight"><?php echo slsOut($pageContent, 'office_contact', 'section_title', 'Contact the Office'); ?></h3>
                            <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-9 leading-relaxed">
                                <?php echo slsOut($pageContent, 'office_contact', 'section_description', ''); ?>
                            </p>
                        ...
                        <div class="bg-white dark:bg-gray-800/50 p-10 sm:p-12 rounded-[2rem] border border-gray-100 dark:border-gray-700">
                            <h4 class="text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight"><?php echo slsOut($pageContent, 'office_contact', 'form_title', 'Spiritual Guidance Request'); ?></h4>
                            <p class="text-lg text-gray-600 dark:text-gray-400 mb-7 leading-relaxed">
                                <?php echo slsOut($pageContent, 'office_contact', 'form_description', ''); ?>
                            </p>
                            <form action="contact_process.php" method="post" class="space-y-4">
                                <input type="hidden" name="inquiry-type" value="Spiritual Guidance Request - Office of Spiritual Life &amp; Development">
                                <div>
                                    <label for="sls_name" class="sr-only">Full name</label>
                                    <input id="sls_name" name="name" type="text" required placeholder="Your Full Name"
                                ...
                                <div>
                                    <label for="sls_email" class="sr-only">Email address</label>
                                    <input id="sls_email" name="email" type="email" required placeholder="Email Address"
                                           class="w-full px-6 py-5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-600 focus:border-blue-600 outline-none text-lg transition">
                                </div>
                                <div>
                                    <label for="sls_msg" class="sr-only">Your request</label>
                                    <textarea id="sls_msg" name="message" rows="5" required placeholder="Your Request or Prayer Need"
                                ...
                                <button type="submit" class="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white text-xl font-black rounded-2xl transition-all shadow-lg hover:shadow-blue-500/25 flex items-center justify-center gap-2">
                                    ...
                                    <?php echo slsOut($pageContent, 'office_contact', 'form_btn_text', 'Submit Request'); ?>
                                </button>
                            </form>
                        </div>
                    </div>
    ...
    <section class="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div class="container relative z-10">
            <div class="sls-wrap text-center">
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight tracking-tight">
                    <?php echo slsOut($pageContent, 'cta_section', 'cta_title', 'Faith, Character &'); ?>
                    <span class="text-yellow-400 block mt-2"><?php echo slsOut($pageContent, 'cta_section', 'cta_highlight', 'Service'); ?></span>
                </h2>
                <p class="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-10 max-w-4xl mx-auto leading-relaxed">
                    <?php echo slsOut($pageContent, 'cta_section', 'cta_description', ''); ?>
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo slsOut($pageContent, 'cta_section', 'button_1_url', 'sld.php'); ?>" class="px-10 py-5 bg-yellow-400 hover:bg-yellow-300 text-blue-900 text-lg font-black rounded-2xl transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        <span class="material-symbols-outlined text-3xl">church</span>
                        <?php echo slsOut($pageContent, 'cta_section', 'button_1_text', 'Ministry Programs'); ?>
                    </a>
                    <a href="<?php echo slsOut($pageContent, 'cta_section', 'button_2_url', 'contact_us.php'); ?>" class="px-10 py-5 bg-white/10 hover:bg-white/20 text-white text-lg font-black rounded-2xl transition-all backdrop-blur-md border-2 border-white/30 transform hover:scale-105 shadow-lg flex items-center justify-center gap-3">
                        <span class="material-symbols-outlined text-3xl">volunteer_activism</span>
                        <?php echo slsOut($pageContent, 'cta_section', 'button_2_text', 'Get Involved'); ?>
                    </a>
                </div>
            </div>
        </div>
